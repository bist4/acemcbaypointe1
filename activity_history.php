...
<body>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    if ($row['ModuleName'] == 'Activity History') {
                        echo '<li class="nav-item">';
                        echo '<a class="nav-link" href="activity_history.php">';
                            ...
                            <div>
                                <table id="example" class="table table-striped table-bordered" cellspacing="0"
                                    ...
                                    <tbody>
                                        <?php
                                        require ('config/db_con.php');
                                        $table = mysqli_query($conn, 'SELECT ah.*, u.ProfilePhoto, u.Fname, u.Lname FROM activity_history ah INNER JOIN users u ON ah.UserID = u.UserID WHERE ah.Active = 1 ORDER BY ActivityHistoryID DESC');
                                        ...
                                        while ($row = mysqli_fetch_assoc($table)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="DataAdd/uploads/<?php echo $row['ProfilePhoto'] ?>"
                                                        alt="userpic" class="avatar-sm rounded-circle me-2" />
                                                    <a href="#" class="text-body">
                                                        <?php echo substr($row['Fname'], 0, 1) . '.' . $row['Lname']; ?>
                                                    </a>
                                                </td>
                                                ...
                                                <td>
                                                    <?php
                                                    if ($row['Action'] == 'ADD') {
                                                        echo '<span class="badge bg-success mb-0">
                                        ADD</span>';
                                                    } else if ($row['Action'] == 'UPDATE') {
                                                        echo '<span class="badge bg-info mb-0">
                                        UPDATE</span>';
                                                    } else if ($row['Action'] == 'DELETE') {
                                                        echo '<span class="badge bg-danger mb-0">
                                        DELETE</span>';
                                                    } else if ($row['Action'] == 'LOCK') {
                                                        echo '<span class="badge badge-soft-danger mb-0">
                                        LOCK</span>';
                                                    } else if ($row['Action'] == 'UNLOCK') {
                                                        echo '<span class="badge badge-soft-success mb-0">
                                        UNLOCK</span>';
                                                    }else if ($row['Action'] == 'SHOW') {
                                                        echo '<span class="badge bg-primary mb-0">
                                        SHOW</span>';
                                                    }else if ($row['Action'] == 'HIDE') {
                                                        echo '<span class="badge bg-secondary mb-0">
                                        HIDE</span>';
                                                    }
                                                    ?>
                                                </td>
    ...
    <script>
        $(document).ready(function () {
            ...
            document.title = "Activity History";
