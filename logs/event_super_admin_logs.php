...
?> -->
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    if ($row['ModuleName'] == 'Event Super Admin Logs' || $row['ModuleName'] == 'Event Admin Logs' || $row['ModuleName'] == 'Event User Logs' || $row['ModuleName'] == 'Event Doctors Logs') {
                        ...
                        $logOptionsSubMenu .= '<a href="' . strtolower(str_replace(' ', '_', $row['ModuleName'])) . '.php">';
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="home.php">Logs</a></li>
                    <li class="breadcrumb-item">Super Admin Logs</li>
                                ...
                                <div class="bootstrap-3-table">
                                    ...
                                    <table id="example" class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        <tbody>
                                            <?php
                                            require ('../config/db_con.php');
                                            $table = mysqli_query($conn, "SELECT sl.*, u.* FROM superadmin_logs sl INNER JOIN users u ON sl.UserID = u.UserID ORDER BY Admin_LogID DESC");
                                            ...
                                            while ($row = mysqli_fetch_assoc($table)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img class="avatar-sm rounded-circle me-2"
                                                            src="../DataAdd/uploads/<?php echo $row['ProfilePhoto'] ?>"
                                                            width="50px" height="50px"
                                                            alt="profile"><?php echo $row['Activity'] ?></td>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#example tfoot th").each(function (index) {
                var title = $(this).text();
                if (index === 2) { // Check if it's the column where you want to have date search
                    $(this).html('<input type="date" placeholder="Search ' + '" class="date-search"/>');
                }  
                else {
