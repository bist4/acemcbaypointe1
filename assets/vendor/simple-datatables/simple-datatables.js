            ...
            (function(global) {
                (function() {
                    ...
                    function p(t, e, s) {
                        ...
                        s.valueDiffing && (t.value && u(i, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") && (i.value = t.value),
                        t.checked && u(i, "HTMLInputElement") && (i.checked = t.checked),
                        t.selected && u(i, "HTMLOptionElement") && (i.selected = t.selected))),
                        i
                    }
                    var f = function(t, e) {
                    ...
                    function m(t, e, s) {
                        ...
                        case s._const.modifyAttribute:
                            ...
                            u(i, "HTMLInputElement") && "value" === e[s._const.name] && (i.value = e[s._const.newValue]);
                            break;
                        ...
                        case s._const.modifyTextElement:
                            ...
                            u(i.parentNode, "HTMLTextAreaElement") && (i.parentNode.value = e[s._const.newValue]);
                            break;
                        ...
                        case s._const.addTextElement:
                            ...
                            u(i.parentNode, "HTMLTextAreaElement") && (i.parentNode.value = e[s._const.value]);
                            break;
                        default:
                    ...
                    var w = function(t) {
                      ...
                      , x = function(t) {
                        ...
                        return Object.prototype.hasOwnProperty.call(t, "attributes") && (e.attributes = v({}, t.attributes)),
                            ...
                            var t = function(t, e, s, i) {
                                ...
                                for (var h = 0; h < o; h++)
                                    for (var u = t[h], p = 0; p < r; p++) {
                                        var f = e[p];
                                        s[h] || i[p] || !M(u, f, d, c) ? l[h + 1][p + 1] = 0 : (l[h + 1][p + 1] = l[h][p] ? l[h][p] + 1 : 1,
                                        l[h + 1][p + 1] >= n && (n = l[h + 1][p + 1],
                                        a = [h + 1, p + 1]))
                                    }
                                return 0 !== n && {
                                    oldValue: a[0] - n,
                        ...
                        return e.forEach((function(e) {
                            !function(t, e, s) {
                                ...
                                case s._const.addElement:
                                    ...
                                    n = null === (i = $(t, d)) || void 0 === i ? void 0 : i.node,
                                ...
                                case s._const.addTextElement:
                                    ...
                                    (n = $(t, d).node).childNodes || (n.childNodes = []),
                    ...
                    function S(t, e) {
                        ...
                        if (u(t, "Text", "Comment"))
                            ...
                            e.valueDiffing && (u(t, "HTMLTextAreaElement") && (s.value = t.value),
                            u(t, "HTMLInputElement") && ["radio", "checkbox"].includes(t.type.toLowerCase()) && void 0 !== t.checked ? s.checked = t.checked : u(t, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") && (s.value = t.value),
                    ...
                    var L = {
                      ...
                      , R = function(t, e) {
                        ...
                        return t.replace(k, (function(r, l) {
                            ...
                            if (d) {
                                if ("svg" === (s = P(r, e.caseSensitive || o)).node.nodeName && (o = !0),
                                n++,
                                !s.voidElement && u && "<" !== u) {
                      ...
                      , H = function() {
                        function t(t, e, s) {
                            this.options = s,
                            this.t1 = "undefined" != typeof Element && u(t, "Element") ? S(t, this.options) : "string" == typeof t ? R(t, this.options) : JSON.parse(JSON.stringify(t)),
                            this.t2 = "undefined" != typeof Element && u(e, "Element") ? S(e, this.options) : "string" == typeof e ? R(e, this.options) : JSON.parse(JSON.stringify(e)),
                            this.diffcount = 0,
                            this.foundAll = !1,
                            this.debug && (this.t1Orig = "undefined" != typeof Element && u(t, "Element") ? S(t, this.options) : "string" == typeof t ? R(t, this.options) : JSON.parse(JSON.stringify(t)),
                            this.t2Orig = "undefined" != typeof Element && u(e, "Element") ? S(e, this.options) : "string" == typeof e ? R(e, this.options) : JSON.parse(JSON.stringify(e))),
                            this.tracker = new V
                        }
                        ...
                        t.prototype.findDiffs = function(t, e) {
                            ...
                            do {
                                ...
                                0 === (s = this.findNextDiff(t, e, [])).length && (D(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : (this.foundAll = !0,
                                N(t),
                        ...
                        t.prototype.findOuterDiff = function(t, e, s) {
                            ...
                            if (Object.prototype.hasOwnProperty.call(t, "data") && t.data !== e.data)
                                return "#text" === t.nodeName ? [(new h).setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)] : [(new h).setValue(this.options._const.action, this.options._const.modifyComment).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)];
                            for (n = t.attributes ? Object.keys(t.attributes).sort() : [],
                            a = e.attributes ? Object.keys(e.attributes).sort() : [],
                            o = n.length,
                            l = 0; l < o; l++)
                                i = n[l],
                                -1 === (r = a.indexOf(i)) ? d.push((new h).setValue(this.options._const.action, this.options._const.removeAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, t.attributes[i])) : (a.splice(r, 1),
                                t.attributes[i] !== e.attributes[i] && d.push((new h).setValue(this.options._const.action, this.options._const.modifyAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.oldValue, t.attributes[i]).setValue(this.options._const.newValue, e.attributes[i])));
                            for (o = a.length,
                            l = 0; l < o; l++)
                                i = a[l],
                                d.push((new h).setValue(this.options._const.action, this.options._const.addAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, e.attributes[i]));
                            return d
                        }
                        ,
                        t.prototype.findInnerDiff = function(t, e, s) {
                            ...
                            for (var u = 0; u < a; u += 1) {
                                var p = i[u]
                                  , f = n[u];
                                o && (p && !f ? "#text" === p.nodeName ? (r.push((new h).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, p.data)),
                                l -= 1) : (r.push((new h).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, x(p))),
                                l -= 1) : f && !p && ("#text" === f.nodeName ? r.push((new h).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, f.data)) : r.push((new h).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, x(f))))),
                                p && f && (!this.options.maxChildCount || a < this.options.maxChildCount ? r = r.concat(this.findNextDiff(p, f, s.concat(l))) : D(p, f) || (i.length > n.length ? ("#text" === p.nodeName ? r.push((new h).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.value, p.data)) : r.push((new h).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.element, x(p)).setValue(this.options._const.route, s.concat(l))),
                                i.splice(u, 1),
                                u -= 1,
                                l -= 1,
                                o -= 1) : i.length < n.length ? (r = r.concat([(new h).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.element, x(f)).setValue(this.options._const.route, s.concat(l))]),
                                i.splice(u, 0, x(f)),
                                o -= 1) : r = r.concat([(new h).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, x(p)).setValue(this.options._const.newValue, x(f)).setValue(this.options._const.route, s.concat(l))]))),
                                l += 1
                            }
                        ...
                        t.prototype.attemptGroupRelocation = function(t, e, s, i, n) {
                            ...
                            }(t, e, s), u = c.gaps1, p = c.gaps2, f = t.childNodes.slice(), m = e.childNodes.slice(), g = Math.min(u.length, p.length), b = [], v = 0, w = 0; v < g; w += 1,
                            v += 1)
                                if (!n || !0 !== u[v] && !0 !== p[v]) {
                                    if (!0 === u[w])
                                        if ("#text" === (l = f[w]).nodeName)
                                            if ("#text" === m[v].nodeName) {
                                                ...
                                                b.push((new h).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.value, l.data)),
                                                u.splice(w, 1),
                                                f.splice(w, 1),
                                            ...
                                            !0 === p[v] ? b.push((new h).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, x(l)).setValue(this.options._const.newValue, x(m[v])).setValue(this.options._const.route, i.concat(w))) : (b.push((new h).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, x(l))),
                                            u.splice(w, 1),
                                            f.splice(w, 1),
                                            g = Math.min(u.length, p.length),
                                            w -= 1,
                                        ...
                                        "#text" === (l = m[v]).nodeName ? (b.push((new h).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.value, l.data)),
                                        u.splice(w, 0, !0),
                                        f.splice(w, 0, {
                                            nodeName: "#text",
                                            data: l.data
                                        }),
                                        g = Math.min(u.length, p.length)) : (b.push((new h).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, x(l))),
                                        u.splice(w, 0, !0),
                                        f.splice(w, 0, x(l)),
                                        g = Math.min(u.length, p.length));
                                    else if (u[w] !== p[v]) {
                                        if (b.length > 0)
                                            return b;
                                        if (r = s[u[w]],
                                        (o = Math.min(r.newValue, f.length - r.length)) !== r.oldValue) {
                                            a = !1;
                                            for (var y = 0; y < r.length; y += 1)
                                                M(f[o + y], f[r.oldValue + y], {}, !1, !0) || (a = !0);
                                            if (a)
                                                return [(new h).setValue(this.options._const.action, this.options._const.relocateGroup).setValue(this.options._const.groupLength, r.length).setValue(this.options._const.from, r.oldValue).setValue(this.options._const.to, o).setValue(this.options._const.route, i)]
                                        }
                                    }
                                } else
                                    ;
                        ...
                        t.prototype.findValueDiff = function(t, e, s) {
                            var i = [];
                            return t.selected !== e.selected && i.push((new h).setValue(this.options._const.action, this.options._const.modifySelected).setValue(this.options._const.oldValue, t.selected).setValue(this.options._const.newValue, e.selected).setValue(this.options._const.route, s)),
                            (t.value || e.value) && t.value !== e.value && "OPTION" !== t.nodeName && i.push((new h).setValue(this.options._const.action, this.options._const.modifyValue).setValue(this.options._const.oldValue, t.value || "").setValue(this.options._const.newValue, e.value || "").setValue(this.options._const.route, s)),
                            t.checked !== e.checked && i.push((new h).setValue(this.options._const.action, this.options._const.modifyChecked).setValue(this.options._const.oldValue, t.checked).setValue(this.options._const.newValue, e.checked).setValue(this.options._const.route, s)),
                            i
                        }
                        ,
                        t
                    ...
                    const j = (t,e,s,{classes: i, format: n, hiddenHeader: a, sortable: o, scrollY: r, type: l},{noColumnWidths: d, unhideHeader: h})=>({
                        nodeName: "TR",
                      ...
                      , q = (t,e,s,i,a,o,{classes: r, hiddenHeader: l, header: d, footer: h, format: u, sortable: p, scrollY: f, type: m, rowRender: g, tabIndex: b},{noColumnWidths: v, unhideHeader: w, renderHeader: _},y,N)=>{
                        const x = {
                            nodeName: "TABLE",
                            attributes: {
                                ...t
                        ...
                        if (x.attributes.class = c(x.attributes.class, r.table),
                        d || h || _) {
                            const t = j(e, i, a, {
                                classes: r,
                                hiddenHeader: l,
                        ...
                        return y.forEach((t=>x.childNodes.push(t))),
                    ...
                    var B = {
                      ...
                      , z = F(B.exports = function() {
                        ...
                        var O = function() {
                            ...
                            ,
                            b.$set = function(t, e) {
                                var s, l = M.p(t), c = "set" + (this.$u ? "UTC" : ""), p = (s = {},
                                s[r] = c + "Date",
                                s[u] = c + "Date",
                                s[d] = c + "Month",
                                s[h] = c + "FullYear",
                            ...
                            b.diff = function(i, u, p) {
                                var f, m = this, g = M.p(u), b = D(i), v = (b.utcOffset() - this.utcOffset()) * e, w = this - b, _ = function() {
                                    return M.m(m, b)
                                };
                                switch (g) {
                                case h:
                    ...
                    const W = (t,e)=>{
                      ...
                      , Z = (t,e=void 0,s,n,a)=>{
                        ...
                        if (t.headings)
                            o.headings = t.headings.map((t=>X(t)));
                        else if (e?.tHead)
                            ...
                            e?.tBodies.length && (o.headings = Array.from(e.tBodies[0].rows[0].cells).map((t=>X(""))));
                    ...
                    class K {
                        ...
                        add(t) {
                            ...
                            if (this.dt.data.headings = this.dt.data.headings.concat([X(t.heading)]),
                    ...
                    const tt = {
                      ...
                      , st = (t,e,s,i,n)=>{
                        let a = [];
                        if (n.firstLast && a.push(et(1, n.firstText, n)),
                        n.nextPrev) {
                            const e = t ? 1 : s - 1;
                    ...
                    exports.DataTable = class {
                        ...
                        init() {
                            if (this.initialized || d(this.dom, this.options.classes.table))
                                return !1;
                            this._virtualDOM = S(this.dom, this.options.diffDomOptions || {}),
                            ...
                            this.data = Z(this.options.data, this.dom, this.columns.settings, this.options.type, this.options.format),
                            this._render(),
                            setTimeout((()=>{
