...
// Assuming $_POST['eventID'] contains the user ID sent from the client-side
$eventID = $_POST['eventID'];

// Query to fetch user data
$table = mysqli_query($conn, "SELECT e.* FROM events e    
...
<form id="eventForm" novalidate enctype="multipart/form-data">
    ...
    <div class="mb-3">
        <label for="eventTitle1" class="form-label">Event Title</label>
        <input type="text" class="form-control" id="eventTitle1" value="<?php echo $row['EventTitle'] ?>">
        <span id="titleError1" class="text-danger"></span> <!-- Error message element -->
    </div>
    <div class="mb-3">
        <label for="eventDesc1" class="form-label">Event Description</label>
        <textarea name="eventDesc1" id="eventDesc1" class="form-control"><?php echo $row['Description'] ?></textarea>
    ...
    <div class="mb-3">
        <div class="row g-0 align-items-center"> <!-- Add align-items-center to vertically align content -->
            <div class="col-md-4">
                <img id="image1Preview" src="DataAdd/uploads/<?php echo $row['Image1'] ?>"
            ...
            <div class="col-md-8">
                ...
                <?php if (isset($row['FrontImage'])): ?>
                    <input type="hidden" id="image1ImageName" value="<?php echo $row['Image1']; ?>">
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
 ...
 <script>
    ...
    $('#updateBtn').click(function (e) {
        ...
        if (!eventTitle1) {
            titleError1.text('Event title is required');
        ...
        if (!eventDesc1) {
            descError1.text('Event description is required');
        ...
        $.ajax({
            url: 'DataUpdate/update_event.php', // Replace with your server-side script URL
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false,
