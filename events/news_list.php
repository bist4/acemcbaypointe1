...
<body>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    if (
                        ...
                        $activeClass = $row['ModuleName'] == 'News List' ? ' active' : '';
                    ...
                    <div class="card">
                        <div class="card-body table-responsive">
                            ...
                            if (isset($_SESSION['UserID'])) {
                                ...
                                $sql = "SELECT Action_Add, ModuleID FROM `privileges` WHERE ModuleID = 15 AND UserID = '" . $_SESSION['UserID'] . "'";
                          ...
                          <i class="bi bi-plus"></i>  
                            ...
                            <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    $name = $_SESSION['Fname'];
                                    if ($_SESSION['UserRoleName'] == 0) {
                                        $table = mysqli_query($conn, "SELECT * FROM news WHERE Status = 'PENDING' AND Active = 1 ORDER BY NewsID DESC");

                                    } else {
                                        $table = mysqli_query($conn, "SELECT * FROM news WHERE Status = 'PENDING' AND Author_News REGEXP '^$name\\s*\\()' AND Active = 1 ORDER BY NewsID DESC");
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-inline-flex gap-3">
                                                    ...
                                                    if (isset($_SESSION['UserID'])) {
                                                        // Prepare the SQL query with proper concatenation
                                                        $sql = "SELECT Action_View, ModuleID FROM `privileges` WHERE ModuleID = 15  AND UserID = '" . $_SESSION['UserID'] . "'";
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($table)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['Title_News']; ?></td>
                                            <td><img src="DataAdd/uploads/<?php echo $row['Image_News']; ?>" alt="news image"
                                                    width="100px" height="100px"></td>
                                            <td>
                                                <?php
                                                // echo $row['Status']; 
                                            ...
                                            <td class="text-center">
                                                <div class="d-inline-flex gap-3">
                                                    ...
                                                    if (isset($_SESSION['UserID'])) {
                                                        // Prepare the SQL query with proper concatenation
                                                        $sql = "SELECT Action_Update, ModuleID FROM `privileges` WHERE ModuleID = 15  AND UserID = '" . $_SESSION['UserID'] . "'";
                                                    ...
                                                    if (isset($_SESSION['UserID'])) {
                                                        // Prepare the SQL query with proper concatenation
                                                        $sql = "SELECT Action_Delete, ModuleID FROM `privileges` WHERE ModuleID = 15  AND UserID = '" . $_SESSION['UserID'] . "'";
        ...
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="newsForm">
                        <div class="mb-3">
                            <label for="eventTitle" class="form-label">News Title</label>
                            <input type="text" class="form-control" id="eventTitle" placeholder="Enter news title">
                            <span id="titleError" class="text-danger"></span> <!-- Error message element -->
                        </div>
                        <div class="mb-3">
                            <label for="eventDesc" class="form-label">News Description</label>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-inline-flex gap-3">
                                            ...
                                            if (isset($_SESSION['UserID'])) {
                                                // Prepare the SQL query with proper concatenation
                                                $sql = "SELECT Action_Approved, ModuleID FROM `privileges` WHERE ModuleID = 15  AND UserID = '" . $_SESSION['UserID'] . "'";
                                            ...
                                            if (isset($_SESSION['UserID'])) {
                                                // Prepare the SQL query with proper concatenation
                                                $sql = "SELECT Action_Reject, ModuleID FROM `privileges` WHERE ModuleID = 15  AND UserID = '" . $_SESSION['UserID'] . "'";
    ...
    <script>
        document.getElementById('newsForm').addEventListener('submit', function (event) {
            ...
            // Validate news title
            if (!eventTitle) {
                titleError.textContent = 'News title is required';
            ...
            if (!eventDesc) {
                descError.textContent = 'News description is required';
            ...
            // Validate image1
            if (!image1) {
                image1Error.textContent = 'News image is required';
            ...
            $.ajax({
                url: 'DataAdd/add_news.php', // Replace with your server-side script URL
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
