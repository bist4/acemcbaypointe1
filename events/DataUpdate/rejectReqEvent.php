...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['eventID']) && is_numeric($_POST['eventID'])) {
        ...
        $decisionStatus = 'Request to edit was rejected by ' . $user;
        $message = 'Your request to edit was rejected';
        ...
        if ($stmt->execute()) {
            ...
            if (isset($_SESSION['Username'])) {
                ...
                if ($resultUserCheck && $resultUserCheck->num_rows > 0) {
                    ...
                    $action = 'UPDATE';
                    $activity = 'Request to edit event title '. $eventTitle .' was rejected';
                    ...
                    $act = 'Your request to edit the event titled '.$eventTitle.' has been rejected.';
